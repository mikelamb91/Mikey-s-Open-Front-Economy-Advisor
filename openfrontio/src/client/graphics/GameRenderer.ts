...
import { EconomyAdvisor } from "./layers/EconomyAdvisor";
import { EconomyAdvisorOverlayLayer } from "./layers/EconomyAdvisorOverlayLayer";
...
export function createRenderer(
  ...
  const economyAdvisor = document.querySelector(
    "economy-advisor",
  ) as EconomyAdvisor;
  if (!(economyAdvisor instanceof EconomyAdvisor)) {
    console.error("economy advisor not found");
  }
  economyAdvisor.game = game;
  economyAdvisor.eventBus = eventBus;
  ...
  const layers: Layer[] = [
    ...
    new EconomyAdvisorOverlayLayer(game, eventBus),
